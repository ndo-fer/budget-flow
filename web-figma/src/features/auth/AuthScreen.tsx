  ...
  return (
    <div className="min-h-screen bg-[#FEF9F4] px-6 py-8 relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
        {/* Coral Blob */}
        <div className="absolute top-10 left-10 w-80 h-80 rounded-full bg-[#FF6B58]/45 blur-lg animate-float-1" />
        {/* Teal Blob */}
        <div className="absolute bottom-10 right-10 w-96 h-96 rounded-full bg-[#29B9AA]/45 blur-lg animate-float-2" />
        {/* Orange Blob */}
        <div className="absolute top-1/3 right-12 w-72 h-72 rounded-full bg-[#FFB347]/45 blur-lg animate-float-3" />
        {/* Blue Blob */}
        <div className="absolute bottom-1/3 left-12 w-72 h-72 rounded-full bg-[#5BAEE8]/45 blur-lg animate-float-4" />
      </div>
