    ...
    <div className="rounded-2xl border border-black/10 bg-white p-6 shadow-sm md:col-span-2">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-bold uppercase tracking-wider text-[#1A2B38]">
            {t("home.progressPlan", "Progress Rencana Bulan Ini").replace("BULAN NAMA", month).replace("NAMA", month)}
          </h3>
        </div>
      ...
      <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="rounded-2xl bg-[#FEF9F4] p-4">
          <div className="flex items-center gap-1 text-xs text-[#7B6E67]">
            ...
            <span>{t("home.planIncome", "Estimasi Pemasukan")}</span>
          </div>
        ...
        <div className="rounded-2xl bg-[#FEF9F4] p-4">
          <div className="flex items-center gap-1 text-xs text-[#7B6E67]">
            ...
            <span>{t("home.planExpense", "Total Pengeluaran")}</span>
          </div>
        ...
        <div className="rounded-2xl bg-[#FEF9F4] p-4">
          <div className="flex items-center gap-1 text-xs text-[#7B6E67]">
            ...
            <span>{t("home.planSavings", "Sisa Rencana")}</span>
          </div>
      ...
      <div className="mt-5 space-y-1">
        <div className="flex justify-between text-xs font-semibold">
          <span className="text-[#7B6E67]">{t("home.categorySpending", "Pemakaian Budget Rencana")}</span>
