...
const styles = StyleSheet.create({
  ...
  errorCard: { backgroundColor: colors.errorSoft, borderRadius: borderRadius.xl, padding: spacing.lg, marginBottom: spacing.xl, borderWidth: 1, borderColor: '#F5C7C0' },
  ...
  sectionHeaderSummary: { color: colors.primary, fontSize: 13, fontWeight: '800' },
  ...
  expenseAmount: { color: colors.primary, fontSize: 13, fontWeight: '800' },
